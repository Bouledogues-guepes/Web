                ...
                foreach ($listtype as $row) {
                    ...
                    <li>
                        <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                            <input id=<?= $value?> type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                            <label for="<?= $value?>" class="w-full ml-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300"><?php echo $value;?></label>
                        </div>
                    </li><?php
                }
                ?>
